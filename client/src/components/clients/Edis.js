...
const ClientEdiIndexComponent = ({
  ...
  return (
    <div style={styles.component} >
      <div>
        <DataTables
          title={`Edis of Client: ${client.name}`}
          ...
          toolbarIconRight={[
            (<ActionIconButton
              key="add"
              iconType="add"
              containerElement={<Link to={`/clients/update/${client.client_id}/edis/create`} />}
            />),
            (<ActionIconButton
              key="back"
              iconType="back"
              containerElement={<Link to={`/clients/update/${client.client_id}/edis`} />}
            />),
          ]}
        />
      </div>
...
ClientEdiIndexComponent.propTypes = {
...
export default ClientEdiIndexComponent;
