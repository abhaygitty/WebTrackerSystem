...
class UpdateClientEdi extends Component {
  ...
  fetchEdi() {
    ...
    this.serverRequestOnFee= $.ajax({
      type: "GET",
      url: `${API_URL}/api/edis/${this.props.params.edinumber}`,
...
UpdateClientEdi.contextTypes = {
  router: PropTypes.object.isRequired
};

UpdateClientEdi.propTypes = {
  params: PropTypes.object.isRequired
};
export default UpdateClientEdi;
