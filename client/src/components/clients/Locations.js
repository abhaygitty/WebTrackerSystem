...
const ClientLocationIndexComponent = ({  // may use props straightaway here
  client,
  tableColumns,
  itemsInPage,
  page,
  ...
  return (
    <div style={styles.component} >
      <div>
        <DataTables
          title={`Locations of Client: ${client.name}`}
          ...
          toolbarIconRight={[
            (<ActionIconButton
              key="add"
              iconType="add"
              containerElement={<Link to={`/clients/update/${client.client_id}/locations/create`} />}
            />),
            (<ActionIconButton
              key="back"
              iconType="back"
...
ClientLocationIndexComponent.propTypes = {
...
export default ClientLocationIndexComponent;
