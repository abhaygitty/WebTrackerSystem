...
const ClientContactIndexComponent = ({  // may use props straightaway here
  client,
  tableColumns,
  itemsInPage,
  page,
  ...
  return (
    <div style={styles.component} >
      <div>
        <DataTables
          title={`Contacts of Client: ${client.name}`}
          ...
          toolbarIconRight={[
            (<ActionIconButton
              key="add"
              iconType="add"
              containerElement={<Link to={`/clients/update/${client.client_id}/contacts/create`} />}
            />),
            (<ActionIconButton
              key="back"
              iconType="back"
...
ClientContactIndexComponent.propTypes = {
...
export default ClientContactIndexComponent;
