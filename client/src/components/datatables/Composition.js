...
import DataTablesTable from './Table';
import DataTablesTableBody from './TableBody';
import DataTablesHeaderColumn from './HeaderColumn';
import DataTablesRow from './Row';
import DataTablesRowColumn from './RowColumn';
import DataTablesHeaderToolbar from './HeaderToolbar';
...
class DataTables extends Component {
  ...
  handleCellClick(rowIndex, columnIndex, event) {
    // console.log('trigger handleCellClick on composition.datatables.client.components');
