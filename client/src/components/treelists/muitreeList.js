...
class MuiTreeList extends Component {
  ...
  handleTouchTap(listItem, index) {
    // console.log('trigger handleTouchTap in muitreelist');
    if (this.searchMode) {
  ...
  render() {
    ...
    const expandedListItems = (this.props.expandedListItems) ? this.props.expandedListItems : this.state.expandedListeItems;
    ...
    // console.log('listItemsModified', listItemsModified);
        ...
        if (listItem._shouldRender) {
          return (
            <MenuItem
              ...
              containerElement={(listItem.children) ? <div/> : (listItem.route && !listItem.disabled) ? <Link to={listItem.route} /> : <div/>}
              onTouchTap={() => {
                if (!listItem.disabled) return this.handleTouchTap(listItem, i);
                return null;
              }} />
          );
        } else {
    ...
    // console.log('listItemsJSX',listItemsJSX);
    ...
    function tagListItemsWithSearchTerm(searchTerm, listItem) {
      const f = (listItem) => {
        ...
        // console.log('In tagListItemsWithSearchTerm, match=', match);
        // console.log('In tagListItemsWithSearchTerm, searchTerm=', searchTerm);
        // console.log('In tagListItemsWithSearchTerm, listItem=', listItem);
        if (match) {
